...
So going back to the 1 + 2 calculation, we can say that when computer runs this, it activates a sequence of logic gates and reaches a result state of switches where specific switches are turn on and off, which is interpreted as the vaue 3.
