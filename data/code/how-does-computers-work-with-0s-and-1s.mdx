...
tldr: Given a simple calculation ex - 1 + 2, the computer technically does not calculate 1 + 2 and gives 3 an answer. It changes it's states of the switches which represents the 3.
