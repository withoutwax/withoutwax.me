...
Able to scan the barcode right away as soon as the App is opened.
Disadvantages:

Have to reach to the top to get to the barcode.
Barcode might take too much space.
stage 02
...
Smoother UI
More space on the top - could be used for different functionality apart from profile
Disadvantages:

Might feel too empty.
Able to scan the barcode when the App is open, but intended to make the user to press the barcode to enlarge the Barcode (two-step process instead of single process).
alternative ver stage 02
