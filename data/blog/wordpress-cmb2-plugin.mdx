...
summary: 'Simple code which helped me create a metabox with plugin: CMB2 in WordPress.'
image: ''
category: 'code'
---
...
CMB2
The plugin that I used was called CMB2.

First, we need to create a function in function.php to display the form in the admin section:

```php
add*action( 'cmb2_admin_init', 'cmb2_sample_metaboxes' );
/* Define the metabox and field configurations.\_/
