...
The interface must be simple. (Easy to navigate - possibly single page application)
It must not confuse the user by having too much functionality. (Must be simple)
...
Click the input area on the screen displayed on the left
Type in the Korean pronunciation and press 'enter'
NOTICE:

This page is prototype of application 'Aㅏ'.
This page purely developed for demonstration purposes, and UI UX experience. Therefore only the selected pronunciation and vocabulary will work.
