export const metadata = {
  ...
  description: "An archive / collection of Will's friends' profile when Will met during 2016-2019.",
  image: '/static/images/wills-nerds/will-s-nerds-04.gif "will's nerds"',
  category: 'project',
