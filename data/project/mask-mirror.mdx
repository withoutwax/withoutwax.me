export const metadata = {
  ...
  description: 'Smart Mirror 🖼 project with a taste of conceptual drop 🎨',
  image: '/static/images/mask-mirror/01-will-captured.gif 'Will captured'',
  category: 'project',
  tags: ['JavaScript', 'clmtrackr', 'Computer Vision', 'Interactive Art'],
};
