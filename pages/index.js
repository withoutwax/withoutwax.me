  ...
  return (
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-4 w-full">
          For anyone who came from this <a href="https://www.youtube.com/user/Calibre097/featured" className="underline text-gray-900 dark:text-gray-100 hover:text-gray-500" target="_blank" rel="noopener noreferrer">YouTube channel</a>, a lof of things changed: I kept following my passion, and now I am a Software Developer. If you are interested in my story, I've shared my story 
