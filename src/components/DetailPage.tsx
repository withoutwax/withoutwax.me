...
// import { getPageProperties, getPageContentV1 } from '@/utils/notion';
...
// import { formatNotionDate } from '@/utils/utils';
...
export default async function DetailPage({ id }: { id: string }) {
  ...
  // const pageBlockChildren = (await getPageContentV1(id)) as ListBlockChildrenResponse;
      ...
      <h1 className="font-bold text-3xl md:text-5xl tracking-tight mb-4 text-black dark:text-white">
        ...
        pageProperties.properties?.Name.title.length > 0
          ? pageProperties.properties?.Name.title
              .filter((text): text is TextRichTextItemResponse => text.type === 'text')
