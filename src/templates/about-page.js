...
const AboutPage = ({ data }) => {
  ...
  return (
    <Layout>
      <section>
        <h2 className="mb-16 flex justify-between">
          <span
            id="about-about-btn"
            className={aboutcssclass}
            role="button"
            tabIndex="0"
            onClick={() => aboutToggle()}
            onKeyDown={() => aboutToggle()}
          >
            About{" "}
          ...
          <span
            id="about-resume-btn"
            className={resumecssclass}
            role="button"
            tabIndex="0"
            onClick={() => resumeToggle()}
            onKeyDown={() => resumeToggle()}
          >
            Resume{" "}
        ...
        {resume ? (
          <ResumePageTemplate aboutResume={frontmatter.aboutResume} />
        ) : (
          <AboutPageTemplate aboutAbout={frontmatter.aboutAbout} />
        )}
      </section>
    </Layout>
  );
